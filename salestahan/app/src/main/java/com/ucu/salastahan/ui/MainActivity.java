...
import com.ucu.salastahan.ui.inventory.InventoryFragment;
import com.ucu.salastahan.ui.inventory.ProductDetailActivity;
import com.ucu.salastahan.ui.sale.ReportFragment;
import com.ucu.salastahan.ui.sale.SaleFragment;
...
public class MainActivity extends FragmentActivity {
	...
	private void initiateActionBar() {
		if (SDK_SUPPORTED) {
			...
			actionBar.addTab(actionBar.newTab().setText(res.getString(R.string.inventory))
					.setTabListener(tabListener), 0, true); //TODO: set true if you want to load this as first fragment
	...
	public void optionOnClickHandler(View view) {
		...
		//Toast.makeText(this, "No function yet, soon to be updated", Toast.LENGTH_SHORT).show();
		viewPager.setCurrentItem(0);
